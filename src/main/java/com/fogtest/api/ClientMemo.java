...
public class ClientMemo {
    ...
    public ClientMemo(long id, long client_id, String notes, Date date, Date created_date, Date modified_date, long created_user_id, long modified_user_id, Date last_sync_time) {
        this.id = id;
        this.client_id = client_id;
        this.notes = notes;
        this.date = date;
